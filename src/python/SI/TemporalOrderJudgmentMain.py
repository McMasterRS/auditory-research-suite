...
from TemporalOrderJudgment.TrialData import *
from TemporalOrderJudgment.SISetupGUI import *
from TemporalOrderJudgment.SISessionData import *
from TemporalOrderJudgment.ExperimentPanel import *
from PTCommon.TrialLogger import *
from TemporalOrderJudgment.ExperimentData import *
import csv, time
import wx
...
session = SISession(name='TemporalOrderJudgment', version = __version__.split()[1]) # may need to change name depending on type
session = session.load()

session.windowTitle = 'Temporal Order Judgment Experiment'
session.experimentType='TOJ'     # SI or TOJ are the choices - determines response values and corresponding output data
...
if not session.demo:
    ...
    from TemporalOrderJudgment.DemoGUI import *
