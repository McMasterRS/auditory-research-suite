...
class BooleanFormatter(Formatter):
	...
	def coerce( self, value ):
		if isinstance(value, bool):
			return value
		lower = value.lower()
		return lower == "true" or lower == "yes" or lower == "on"
		

# Placeholder...
class TupleFormatter(Formatter):
    """
    Formats a fixed-length tuple of items defined by a sub-formatter.
    """
    
    __metaclass__ = FormatterMeta
    
    def __init__(self, size, subFormatter, *args, **kwargs):
